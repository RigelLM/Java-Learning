...
public final class XMLTreeExploration {
    ...
    private static void printMiddleNode(XMLTree xt, SimpleWriter out) {
        ...
        int index = num / 2;
        XMLTree middleChild = xt.child(index);

        String resultLabel = middleChild.label();
        boolean resultISTAG = middleChild.isTag();
        int resultNum = 0;
        if (resultISTAG) {
            resultNum = middleChild.numberOfChildren();
        }

        out.println(resultLabel);
        out.println(resultISTAG);
    ...
    public static void main(String[] args) {
        ...
        String titleTextString = titleText.label();
        out.println(titleTextString);
        ...
        out.println(astronomy.hasAttribute("sunset")
                && astronomy.attributeValue("sunset") == "midday");
